    ...
    <>
      ...
      <main className="container">
        ...
        <section className="carousel-wrap" aria-label="Destacados">
          <button type="button" className="arrow left" aria-label="Anterior" onClick={() => scrollBySlide(-1)}>
          ...
          <button type="button" className="arrow right" aria-label="Siguiente" onClick={() => scrollBySlide(1)}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        ...
        <nav className="pagination" aria-label="Paginación de productos">
          <button className="page-btn" onClick={() => goPage(page - 1)} disabled={page === 1} aria-label="Página anterior">
            ← Anterior
          </button>
          <span className="page-info">
            Página <strong>{page}</strong> de <strong>{totalPages}</strong>
          </span>
          <button className="page-btn" onClick={() => goPage(page + 1)} disabled={page === totalPages} aria-label="Página siguiente">
            Siguiente →
          </button>
        </nav>
      </main>
