...
import Categoria from "../Categoria/Categoria"; // 👈 importamos Categoria
import Header from "../../components/Header/Header";
import Footer from "../../components/Footer/Footer";
import Chatbot from "../../components/ChatBot/ChatBot";
import { agregarAlCarrito, getCarrito, quitarDelCarrito } from "../../carrito";


export default function Home({ isAuthenticated: propAuth }) {

    //Renombre el state local para no chocar con la prop
  ...
  const handleAdd = (producto) => {
    if (!isAuthenticated) {
      navigate("/login");
        ...
        agregarAlCarrito(producto); //Guardamos el producto en localStorage
